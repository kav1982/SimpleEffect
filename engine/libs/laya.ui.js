(function (exports, Laya) {
    ...
    class AutoBitmap extends Laya.Graphics {
        ...
        changeSource() {
            ...
            if (imageType == 0) {
                ...
                let cmd = Laya.DrawFilledImageCmd.create(source, 0, 0, width, height, this._fillMethod, this._fillOrigin, this._fillClockwise, this._fillAmount, this._color);
                this._setDrawGridCmd(cmd);
            }
        }
    ...
    (function (ImageType) {
        ...
        ImageType[ImageType["Filled"] = 1] = "Filled";
    })(exports.ImageType || (exports.ImageType = {}));
    exports.FillMethod = void 0;
    (function (FillMethod) {
        FillMethod["Horizontal"] = "0";
        FillMethod["Vertical"] = "1";
        FillMethod["Radial90"] = "2";
        FillMethod["Radial180"] = "3";
        FillMethod["Radial360"] = "4";
    })(exports.FillMethod || (exports.FillMethod = {}));
    exports.OriginHorizontal = void 0;
    (function (OriginHorizontal) {
        OriginHorizontal[OriginHorizontal["Left"] = 0] = "Left";
        OriginHorizontal[OriginHorizontal["Right"] = 1] = "Right";
    })(exports.OriginHorizontal || (exports.OriginHorizontal = {}));
    exports.OriginVertical = void 0;
    (function (OriginVertical) {
        OriginVertical[OriginVertical["Bottom"] = 0] = "Bottom";
        OriginVertical[OriginVertical["Top"] = 1] = "Top";
    })(exports.OriginVertical || (exports.OriginVertical = {}));
    exports.Origin90 = void 0;
    (function (Origin90) {
        Origin90[Origin90["BottomLeft"] = 0] = "BottomLeft";
        Origin90[Origin90["TopLeft"] = 1] = "TopLeft";
        Origin90[Origin90["TopRight"] = 2] = "TopRight";
        Origin90[Origin90["BottomRight"] = 3] = "BottomRight";
    })(exports.Origin90 || (exports.Origin90 = {}));
    exports.Origin180 = void 0;
    (function (Origin180) {
        Origin180[Origin180["Top"] = 0] = "Top";
        Origin180[Origin180["Left"] = 1] = "Left";
        Origin180[Origin180["Bottom"] = 2] = "Bottom";
        Origin180[Origin180["Right"] = 3] = "Right";
    })(exports.Origin180 || (exports.Origin180 = {}));
    exports.Origin360 = void 0;
    (function (Origin360) {
        Origin360[Origin360["Top"] = 0] = "Top";
        Origin360[Origin360["Right"] = 1] = "Right";
        Origin360[Origin360["Bottom"] = 2] = "Bottom";
        Origin360[Origin360["Left"] = 3] = "Left";
    })(exports.Origin360 || (exports.Origin360 = {}));
    class Image extends UIComponent {
        ...
        get imageType() {
            if (this._graphics.imageType)
                return this._graphics.imageType;
            return 0;
        }
        set imageType(value) {
            this._graphics.imageType = value;
        }
        get fillMethod() {
            if (this._graphics.fillMethod)
                return this._graphics.fillMethod.toString();
            return exports.FillMethod.Horizontal;
        }
        set fillMethod(value) {
            let num = 0;
            if (value == exports.FillMethod.Horizontal)
                num = 0;
            else if (value == exports.FillMethod.Vertical)
                num = 1;
            else if (value == exports.FillMethod.Radial90)
                num = 2;
            else if (value == exports.FillMethod.Radial180)
                num = 3;
            else if (value == exports.FillMethod.Radial360)
                num = 4;
            this._graphics.fillMethod = num;
            this._graphics.fillOrigin = 0;
        }
        get fillOrigin() {
            if (this._graphics.fillOrigin)
                return this._graphics.fillOrigin;
            return 0;
        }
        set fillOrigin(value) {
            this._graphics.fillOrigin = value;
        }
        get fillClockwise() {
            if (this._graphics.fillClockwise)
                return this._graphics.fillClockwise;
            return false;
        }
        set fillClockwise(value) {
            this._graphics.fillClockwise = value;
        }
        get fillAmount() {
            if (this._graphics.fillAmount)
                return this._graphics.fillAmount;
            return 0;
        }
        set fillAmount(value) {
            this._graphics.fillAmount = value;
        }
    }
